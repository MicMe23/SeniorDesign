...
## Table of Contents
1. [Project Description](documentation/project_description.md)
2. [User Stories](documentation/User_Stories.md)
3. [Design Diagrams 1 and 2](documentation/D0_and_D1.png)
-  [Design Diagram 3](documentation/D2.png)
4. [Tasks & Timeline](documentation/task_list.md)
5. [ABET Concerns Essay](documentation/Constraints%20Essay.docx)
6. [PPT Slideshow](documentation/Assignment8.pptx)
7. Self-Assessments
...
-   [JP](documentation/JP_bio)
9. Budget - ~$100
10. Appendix
-   Statics, Dynamics, and Stresses in Solids -- Mechanics in Analysis and Design 1st edition
